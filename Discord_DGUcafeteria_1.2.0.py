...
file_handler = logging.FileHandler("Discord_DGUcafeteria_1.2.0.py.log")
...
class MenuCollection:
    sangrokwon3flunch = discord.Embed(title="상록원 3층 중식메뉴", description="상록원 3층 중식메뉴", color=0x00ff00)
    ...
    sangrokwon3fdinner = discord.Embed(title="상록원 3층 석식메뉴", description="상록원 3층 석식메뉴", color=0x00ff00)
    ...
    sangrokwon2flunch = discord.Embed(title="상록원 2층 중식 메뉴", description="상록원 2층 중식 메뉴", color=0x00ff00)
    ...
    sangrokwon2fdinner = discord.Embed(title="상록원 2층 석식 메뉴", description="상록원 2층 석식 메뉴", color=0x00ff00)
    ...
    sangrokwon1f = discord.Embed(title="상록원 1층 메뉴", description="상록원 1층 메뉴", color=0x00ff00)
    sangrokwon1f.add_field(name="상록원 1층", value=sangrok_1f_menu)
    grutergi_lunch = discord.Embed(title="그루터기 중식 메뉴", description="그루터기 중식 메뉴", color=0x00ff00)
    ...
    grutergi_dinner = discord.Embed(title="그루터기 석식 메뉴", description="그루터기 석식 메뉴", color=0x00ff00)
    ...
    gardencook = discord.Embed(title="가든쿡 메뉴", description="가든쿡 메뉴", color=0x00ff00)
    ...
    dormitory_lunch = discord.Embed(title="남산학사(기숙사)식당 중식 메뉴", description="남산학사(기숙사)식당 중식 메뉴", color=0x00ff00)
    ...
    dormitory_dinner = discord.Embed(title='남산학사(기숙사)식당 석식 메뉴', description="남산학사(기숙사)식당 석식 메뉴", color=0x00ff00)
    ...
    tomorrow_sangrokwon3flunch = discord.Embed(title="내일 상록원 3층 중식", description="내일 상록원 3층 중식", color=0x00ff00)
    ...
    tomorrow_sangrokwon3fdinner = discord.Embed(title="내일 상록원 3층 석식", description="내일 상록원 3층 석식", color=0x00ff00)
    ...
    tomorrow_sangrokwon2flunch = discord.Embed(title="내일 상록원 2층 중식", description="내일 상록원 2층 중식", color=0x00ff00)
    ...
    tomorrow_sangrokwon2fdinner = discord.Embed(title="내일 상록원 2층 석식", description="내일 상록원 2층 석식", color=0x00ff00)
    ...
    tomorrow_sangrokwon1f = discord.Embed(title="내일 상록원 1층", description="내일 상록원 1층", color=0x00ff00)
    tomorrow_sangrokwon1f.add_field(name="상록원 1층", value=tomorrow_sangrok_1f_menu)
    tomorrow_grutergi_lunch = discord.Embed(title="내일 그루터기 중식", description="내일 그루터기 중식", color=0x00ff00)
    ...
    tomorrow_grutergi_dinner = discord.Embed(title="내일 그루터기 석식", description="내일 그루터기 석식", color=0x00ff00)
    ...
    tomorrow_gardencook = discord.Embed(title="내일 가든쿡 메뉴", description="내일 가든쿡 메뉴", color=0x00ff00)
    ...
    tomorrow_dormitory_lunch = discord.Embed(title="내일 남산학사(기숙사)식당 중식", description="내일 남산학사(기숙사)식당 중식", color=0x00ff00)
    ...
    tomorrow_dormitory_dinner = discord.Embed(title="내일 남산학사(기숙사)식당 석식", description="내일 남산학사(기숙사)식당 석식", color=0x00ff00)
